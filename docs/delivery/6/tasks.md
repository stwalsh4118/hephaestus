...
| 6-6 | [Teardown & Graceful Cleanup](./6-6.md) | Done | Implement full teardown of managed containers and network, wired into server shutdown |
| 6-7 | [E2E CoS Test](./6-7.md) | Done | End-to-end tests verifying all PBI 6 acceptance criteria |
