...
| 2-6 | [Integrate Drag-and-Drop from Palette to Canvas](./2-6.md) | Done | Wire onDrop/onDragOver handlers to create nodes from palette drops |
| 2-7 | [E2E CoS Test](./2-7.md) | Done | Verify all PBI-2 acceptance criteria end-to-end |
