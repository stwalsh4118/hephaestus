...
|----|-------|-----------|--------|----------------------------------|
| 1 | Developer | As a developer, I want the project scaffolded with Next.js frontend, Go backend, and Docker dev environment so that I have a working foundation to build on | Proposed | Monorepo structure created; Next.js app runs on dev server; Go backend compiles and serves HTTP; Docker Compose dev environment starts all services; basic CI lint/build passes |
